...
def show_quick_help(parent):
    ...
    help_text = (
        ...
        "algorithms, Panda for manipulating Excel files. KherveFitting is dual-licensed: under the GNU GPL v3.0 "
        "for open-source, academic, and non-commercial use, and under a separate Commercial Licence for use in "
        "proprietary or closed-source products (contact gwilherm.kerherve@gmail.com). When using KherveFitting in "
        "academic or research contexts, appropriate citation would be appreciated to acknowledge the software's "
        "contribution.</p>"
