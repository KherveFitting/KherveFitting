...
class ExcelDropTarget(wx.FileDropTarget):
    ...
    def _process_single_dropped_file(self, file):
        ...
        if file.lower().endswith('.xlsx'):
            ...
            from libraries.FileMenu.AVG_Import import open_avg_file
            wx.CallAfter(open_avg_file, self.window, file)
            return True
